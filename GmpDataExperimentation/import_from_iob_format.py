...
# to convert normal BOI formatted data files to text and label in order to use https://colab.research.google.com/github/NVIDIA/NeMo/blob/main/tutorials/nlp/Token_Classification_Named_Entity_Recognition.ipynb#scrollTo=jrx2ZXHrCHb_
