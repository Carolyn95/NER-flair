...
def testModel(model_dir, test_sent=None, test_file_dir=None):
  ...
  if test_file_dir:
    ...
    test_result, test_loss = model.evaluate(test_data, out_path=test_file_dir + '/test_20201124.tsv')
...
if __name__ == '__main__':
  ...
  testModel('conll_03/models_20201124', test_sent='Alejandro Lanusse , the former dictator who ruled Argentina for two years , died at age 78 on Monday .')
